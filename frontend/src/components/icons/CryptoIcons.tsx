...
export const BitcoinIcon: React.FC<SvgIconProps> = (props) => (
...
export const SuiIcon: React.FC<SvgIconProps> = (props) => (
  <SvgIcon {...props} viewBox="0 0 32 32">
    <path
      fill="#6FBCF0"
      d="M16 32C24.8366 32 32 24.8366 32 16C32 7.16344 24.8366 0 16 0C7.16344 0 0 7.16344 0 16C0 24.8366 7.16344 32 16 32Z"
    ...
    <path
      fill="#fff"
      d="M21.5 10.5h-11c-1.1 0-2 .9-2 2v7c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2v-7c0-1.1-.9-2-2-2zm-5.5 9h-5.5v-7h5.5v7zm5.5 0h-4.5v-7h4.5v7z"
    />
  </SvgIcon>
); 